  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center sm:p-6" role="dialog" aria-modal="true" aria-label="New appointment" ref={dialogRef}>
      ...
      {/* overscroll-contain - same fix as the chat panels: without it,
          ...
          modal's edge. */}
      <div className="relative w-full h-full sm:h-auto sm:max-w-lg sm:max-h-[calc(100vh-3rem)] overflow-y-auto overscroll-contain rounded-none sm:rounded-3xl bg-surface border-line sm:border-2 shadow-[0_30px_70px_-25px_rgba(36,28,24,0.45)] animate-rise">
