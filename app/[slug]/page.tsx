  ...
  return (
    <AccentScope color={business.accent_color} className="min-h-screen bg-paper">
      ...
      {/* Full-bleed now - was boxed inside max-w-6xl with side padding and
          ...
          Chat-first hero (ChatHero.tsx + InfoPanel.tsx) was tried and
          reverted here - the idea was right, the execution wasn't, per
          direct feedback. Back to this, the proven version, rather than
          iterating further on the chat-first layout for now. */}
              ...
              <div className="max-w-2xl mx-auto text-center">
                ...
                <div className="space-y-4">
                  ...
                  {business.description && (
                    // line-clamp-3 on mobile, sm:line-clamp-none from
                    // there up - a business owner can type as long a
                    // description as they like, and an unclamped one on
                    // a phone was crowding the hero, pushing the actual
                    // "book" buttons further down than a customer should
                    // have to scroll for them. Real content is truncated,
                    // not hidden - the full text is still on the About
                    // page (showAbout above) for anyone who wants it.
                    <p className="max-w-[54ch] mx-auto text-[17px] leading-relaxed text-white/90 sm:text-[19px] line-clamp-3 sm:line-clamp-none">
                      {business.description}
                    </p>
                  )}
                </div>
