...
export default async function AccountPage() {
  ...
  const { data: bookings } = await supabaseAdmin
    .from('bookings')
    .select(
      'id, business_id, customer_phone, start_time, status, businesses(name, slug, timezone, logo_url), services!bookings_service_business_fk(name, duration_minutes, price)'
    )
